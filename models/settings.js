...
module.exports = {
    ...
    CMSDISCRIPTION : 'Jing CMS',
    SITEKEYWORDS : 'Jing CMS',
    SITEBASICKEYWORDS : 'Jing CMS', // 基础关键词


    SYSTEMMANAGE : new Array('sysTemManage','JingCMS后台管理'),  // 后台模块(系统管理)
